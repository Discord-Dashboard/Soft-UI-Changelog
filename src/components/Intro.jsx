    ...
    <>
      ...
      <h1 className="mt-14 font-display text-4xl/tight font-light text-white">
        ...
        <span className="text-sky-300">
          for Discord Dashboards Soft-UI theme
        </span>
      </h1>
      <p className="mt-4 text-sm/6 text-gray-300">
        Here you can find all the latest updates for our Soft-UI theme for
        Discord Dashboards.
      </p>
      <SignUpForm />
      <div className="mt-8 flex flex-wrap justify-center gap-x-1 gap-y-3 sm:gap-x-2 lg:justify-start">
        <IconLink
          href="https://dbd-docs.assistantscenter.com/soft-ui/"
          icon={BookIcon}
          className="flex-none"
        >
          Documentation
        ...
        <IconLink
          href="https://github.com/Discord-Dashboard/Soft-UI"
          icon={GitHubIcon}
          className="flex-none"
        >
          GitHub
...
export function IntroFooter() {
  return (
    <p className="flex items-baseline gap-x-2 text-[0.8125rem]/6 text-gray-500">
      Brought to you by{' '}
      <IconLink
        href="https://discord.gg/Nkc8MWxHRD"
        icon={DiscordIcon}
        compact
        large
      >
        Assistants Center Team
      </IconLink>
    </p>
  )
}
